...
bacdive_stats <- generate_summary_stats(bacdive_molecule_counts_metadata, category_col = "category")
...
plot_molecule_distribution(bacdive_molecule_counts_metadata, category_col="fermented_food", include_peptides = FALSE)
...
mag_stats <- generate_summary_stats(mag_molecule_counts_metadata, category_col="ingredient_group")
