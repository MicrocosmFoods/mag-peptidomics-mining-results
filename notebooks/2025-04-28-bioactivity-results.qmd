...
write_tsv(filtered_ff_mag_bioactivity, "../results/2025-04-24-mag-results/2025-07-08-filtered-mag-bioactivity-df.tsv")
...
mag_totals <- mag_metadata %>% 
  ...
  count() %>% 
  arrange(desc(n)) %>% 
  mutate(category_label = paste0(!!sym("food_name"), "\n (n=", n, ")"))
