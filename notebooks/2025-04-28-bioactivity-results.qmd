...
proteomics_bioactivity_df <- prepare_bioactivity_analysis(proteomics_bioactivity_metadata)
...
proteomics_summary_stats <- generate_bioactivity_summary(proteomics_bioactivity_df)
